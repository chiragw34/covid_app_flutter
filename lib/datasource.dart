...
Color accentBlack = Color(0xff202c3b);

class DataSource {
  static String quote =
      'Nothing in life is to be feard, it is only to be understood. Now is the time to understand more, so that we may fear less.';
